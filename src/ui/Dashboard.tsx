  ...
  return (
    <motion.div 
      ...
      onClick={(e) => {
        ...
        const component = target.closest('[data-component]')?.getAttribute('data-component') || target.tagName;
        trackEvent('component_click', { component, text: target.innerText?.substr(0, 20) });
      }}
            ...
            {resultado ? (
              <>
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-8">
                  {/* Coluna 1: Matriz WEF */}
                  <motion.div data-component="matriz-wef" variants={itemVariants} className="lg:col-span-2 bg-zinc-900/20 border border-zinc-800/50 p-8 relative overflow-hidden group">
                ...
                {hasHidden && (
                  <motion.div 
                    data-component="hidden-patterns"
                  ...
                  >
                    ...
                    <p className="max-w-3xl text-zinc-400 leading-relaxed italic">
                      "A IA detectou um padrão entre seu sentênio atual e sua volatilidade de resposta: você está em uma rara janela de convexidade positiva, onde o risk de transição é superado pelo ganho de capital simbólico."
                    </p>
                  </motion.div>
                )}
